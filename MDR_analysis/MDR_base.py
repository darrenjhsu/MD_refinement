...
#// mdtraj
            ...
            comp.superpose(crystalComp, frame=0, atom_indices=range(0,250))
            self.initialRMSD = (np.sqrt((mdtraj.rmsd(comp, crystalComp, frame=0, atom_indices=range(crystalComp.n_atoms-400, crystalComp.n_atoms)))**2/self.lig_len*400)*10)
...
class MolecularDynamicsRefinement:
    def __init__(self, root='./', simulationPrefixes=['EM','QR','MD'], ligand_res=56):
        ...
        with open(self.planningFolder + 'simulation_config.json', 'r') as f:
